package com.poja.poja_sary_std22104.unit;
...
import com.poja.poja_sary_std22104.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja.poja_sary_std22104.endpoint.event.gen.UuidCreated", payload);
